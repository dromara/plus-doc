...
<br>
**小本生意 用心录制 拒绝砍价 目前已更新到 157 集**<br>
...
> 目前已经录制了160集总时长为50多个小时 预计总时长80多个小时
> 
...
146. apifox 接口文档工具
147. 使用apifox管理项目api
148. lua脚本介绍与基本语法-打印、基本类型、变量、运算符
149. lua脚本语法-流程控制、table、string、可变参（pack、unpack）
150. lua脚本语法-元表和面向对象
151. lua脚本语法-协程、文件操作、包管理
152. 队列与QueueUtils队列工具的介绍
153. 普通队列的添加、获取、移除、销毁和订阅
154. 有界队列的设置、添加与获取
155. 延迟队列的添加、获取、移除与销毁
156. 优先队列的添加、获取、移除与销毁
157. 防重幂等设计(防重提交 参考美团GTIS系统)
158. 限流功能使用(全局、IP、集群实例限流)
159. 短信功能配置与使用
160. 邮件功能配置与使用
161. 翻译模块讲解(三种模式)
162. 翻译用户名、字典、ossId转url、对象翻译
163. 数据脱敏讲解(内置脱敏策略)
164. 数据加解密-配置与用法
165. 数据加解密-mybatis拦截器
166. 单元测试 JUnit5、注解与断言
167. 单元测试 基于springboot环境
168. 单元测试 带参数单元测试
169. 单元测试 标签单元测试
170. ElementUI介绍和使用
171. ES6语法介绍
